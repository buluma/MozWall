...
(function() {
  ...
  if ((base = this.Fontana).datasources == null) {
    base.datasources = {};
  }
  ...
  this.Fontana.datasources.Static = (function() {
    ...
    * getMessages will call a callback with the same list of messages.
     */
    function Static(messages1) {
      this.messages = messages1 != null ? messages1 : [];
    }
    ...
    * getMessages uses extractMessages to keep a running list of messages.
    ...
    HTML.prototype.getMessages = function(callback) {
      ...
      this.extractMessages().forEach(function(message) {
        var ref;
        if (ref = message.id, indexOf.call(ids, ref) < 0) {
  ...
  this.Fontana.datasources.TwitterSearchFA = (function(superClass) {
    extend(TwitterSearchFA, superClass);
...
(function() {
  var base, monthNames, vendors;

  if (this.Fontana == null) {
    this.Fontana = {};
  }

  if ((base = this.Fontana).utils == null) {
    base.utils = {};
  }
...
(function() {
  ...
  transitionEffects = ['fade-in', 'compress', 'hinge', 'lightspeed', 'scroll-up', 'scroll-down', 'slide', 'tilt-scroll', 'vertigo', 'zoom-in'];
